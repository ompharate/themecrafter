    ...
    <div>
      ...
      >
        ...
        <div className=" w-full">
          <div className="flex  flex-wrap  items-center flex-row justify-around mt-20 ">
              ...
              <div class="flex flex-col bg-white rounded-3xl">
                  ...
                  <div class="grid items-center justify-center w-full grid-cols-1 text-left">
                    <div>
                      ...
                      <p class="mt-2 text-sm text-gray-500">
                        Unleash your style! Dive into our collection of stunning
                        themes and find the perfect fit for you.
                      </p>
                    </div>
                    <div class="mt-6">
                      <p>
                ...
                <div class="flex px-6 pb-8 sm:px-8">
                  <Link
                    ...
                    class="flex items-center justify-center w-full px-6 py-2.5 font-semibold text-center text-white duration-200 bg-[#7747ff] border-2 border-[#7747ff] rounded-full nline-flex hover:bg-transparent hover:border-black hover:text-black focus:outline-none focus-visible:outline-black text-sm focus-visible:ring-black"
                    to={"/shop"}
                  >
                    Explore
                  </Link>
